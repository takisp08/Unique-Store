...
//voice state update event to check joining/leaving channels
  ...
  if (oldState.channelID && !newState.channelID) {
          ...
          if (jointocreatemap.get(`tempvoicechannel_${oldState.guild.id}_${oldState.channelID}`)) {
            ...
            if (vc.members.size < 1) { 
              ...
              console.log(" :: " + oldState.member.user.username + "#" + oldState.member.user.discriminator + " : Έγινε move")
  ...
  if (oldState.channelID && newState.channelID) {
    ...
    async function jointocreatechannel(user) {
      //log it 
      console.log(" :: " + user.member.user.username + "#" + user.member.user.discriminator + " : Μπήκε wfs ")
      ...
      await user.guild.channels.create(`📞Support`, {
        ...
        await vc.overwritePermissions([
          {
            id: vc.channel.guild.roles.everyone,
